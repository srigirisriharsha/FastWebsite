import { useAppBarHeight } from "./Navbar"
import { Container, Toolbar, Typography } from "@material-ui/core";

export const CustomContainer = () => {
    var appBarHeight = useAppBarHeight()
    console.log("asdad1",useAppBarHeight())

    return <div style={{backgroundColor:"red"}}> <Typography>This is the home page</Typography>{" "}
    <Typography>
